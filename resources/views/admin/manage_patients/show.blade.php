...
<div class="card mx-auto shadow-lg border-0" style="max-width: 950px; max-height: 650px; overflow-y: auto;">
    ...
    <div class="card-body p-4 bg-light">
        ...
        <div class="text-center mt-4">
            <a href="{{ route('admin.manage_patients.index') }}" class="btn btn-secondary">Back to List</a>
            <a href="{{ route('admin.manage_patients.edit', $patient->id) }}" class="btn btn-primary">Edit Patient</a>
        </div>
...
<button onclick="topFunction()" id="backToTopBtn" title="Go to top" 
    style="position: fixed; bottom: 40px; right: 40px; display:none; background-color:#198754; color:white; border:none; padding:10px 15px; border-radius:50%; font-size:16px; cursor:pointer;">
    ↑
</button>
